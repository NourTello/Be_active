...
const translations = {
  en: {
    ...
    homeExercisesTitle: 'Home Exercises',
    homeExercisesSub: 'No-equipment workouts tailored to your BMI & health profile',
    sets: 'Sets',
    reps: 'Reps',
  ...
  ar: {
    ...
    homeExercisesTitle: 'تمارين منزلية',
    homeExercisesSub: 'تمارين بدون معدات مصممة حسب مؤشر كتلة جسمك وحالتك الصحية',
    sets: 'مجموعات',
    reps: 'تكرارات',
    difficulty: 'الصعوبة',
